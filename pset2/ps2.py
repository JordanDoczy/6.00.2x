...
class RectangularRoom(object):
    ...
    def isTileCleaned(self, m, n):
        ...
        pos = Position(m,n)
        index = self.getIndex(pos)
        return (self.tiles[index] == 1) if self.isPositionInRoom(pos) else False
    ...
    def getIndex(self, pos):
        ...
        returns: Return the position as an index.
        """
    ...
    def getPosition(self, index):
        x = math.floor(index / self.height)
        y = index % self.height
        return Position(x, y)
    ...
    def getNumCleanedTiles(self):
        ...
        returns: an integer
        """
        return len([tile for tile in self.tiles if 1 == tile])
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        index = self.getIndex(pos)
        return index >= 0 and index < self.getNumTiles()
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for trialAttempt in range(num_trials):
